---
layout: post
title: "Authorization & Authentication from backend perspective pt2: OAuth basics"
...
During the article, the main source of information is my experience +  official RFC: [https://www.rfc-editor.org/rfc/rfc6749](https://www.rfc-editor.org/rfc/rfc6749)
...
This topic is one of the hardest for understanding. After 3 projects that were using OAuth + OpenId Connect, after researching .NET Core source code, etc eventually I got some understanding. \
 \
This article is addressed to me in the past. I’ll show the easy and simple way to understand OAuth, on top of that we will implement OAuth flow on our own: Resource Server + Authorization Server + Client.
...
**Authentication** - [https://andreyka26.com/authorization/2022/09/02/auth-from-backend-perspective-pt1/#/authorization--authentication](https://andreyka26.com/authorization/2022/09/02/auth-from-backend-perspective-pt1/#/authorization--authentication)

**Authorization** - [https://andreyka26.com/authorization/2022/09/02/auth-from-backend-perspective-pt1/#/authorization--authentication](https://andreyka26.com/authorization/2022/09/02/auth-from-backend-perspective-pt1/#/authorization--authentication)
...
**Authorization Server** - the server authenticates **Resource Owner** and issues **Access Token**s to be used by **Client**. It could exchange Refresh Tokens for Access Tokens.
...
**Client** - the application that communicates with **Resource Server** and **Authorization Server** on behalf of **Resource Owner**. It could be Mobile, Desktop, and Web Applications..
...
**User Agent** - almost always it is browser ([https://www.rfc-editor.org/rfc/rfc2616#section-1.3](https://www.rfc-editor.org/rfc/rfc2616#section-1.3))
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image15.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image11.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image1.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image3.png "image_tooltip")
...
**_MUST first verify the identity of the resource owner.  The way in_**
...
In this demo, I will demonstrate the Authorization Code flow with Github. The sample could be found here: [https://github.com/andreyka26-git/dot-net-samples/tree/main/AuthorizationSample/Custom/GithubCustom](https://github.com/andreyka26-git/dot-net-samples/tree/main/AuthorizationSample/Custom/GithubCustom)
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image5.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image9.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image8.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image7.png "image_tooltip")



![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image10.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image14.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image2.png "image_tooltip")
 \
 \
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image4.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image13.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image6.png "image_tooltip")
...
![alt_text](/assets/2022-11-25-auth-from-backend-perspective-pt2-oauth-basics/image12.png "image_tooltip")
